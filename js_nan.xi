...
NaN .
. Специальное значение, означающую вычислительную ошибку при неправильной 
  математической операции. |Not A Number|.
. Любая математическая операция с {NaN} вернет {NaN}.
  |{js}  
  | "не число" / 2 - 1 // NaN
