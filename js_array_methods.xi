...
Методы .
  ...
  . Изначальный массив |изменяется| / |мутирует|.
    ...
    | console.log(pushMethod); // 4 - длина нового массива
  ...
  . Принимает <разделитель>,
    возвращает <строка>.
  . Изначальный массив `не изменяется`. Создает строку.
    |{js}  
  ...
  . Изначальный массив ^изменяется^ - к нему добавляются указанные элементы.
  [.splice()#] .
  ...
  . Принимает `3` аргумента.
    ...
    третий: {замена (на что заменить) необязательный}
...
Методы перебора .
  ...
  . Принимает {callback}, который состоит из:
    ...
    |   console.log("(.forEach())", `${i}: ${el} внутри массива ${arr}.`);
    | });
      // index0: 2 внутри массива arr1 ...
      // index1: 3 внутри массива arr1 ...
      // index2: 6 внутри массива arr1 ...
  [.map()#] .
  ...
  . Изначальный массив `не изменяется`. Создает новый массив.
  [.reduce()#] .
  . Применяет функцию reducer к каждому элементу массива, возвращая одно 
    результирующее значение.
  . Принимает {callback}, который состоит из:
    {аккумулятор(получаемое значение после каждого выполнения) обязательный},
    {элемент(текущий обрабатываемый элемент в массиве) обязательный},
    {индекс(индекс текущего элемента) необязательный},
    {массив(который используется) необязательный}.
